...
exports.new = function(req, res) {
	...
	{dni: "DNI", nombre: "Nombre", apellido1: "Apellido1", apellido2: "Apellido2", email: "E-mail", grupoAlumno: "1"}
	);
	...
	.then(
		function(err){
			...
			res.render('alumnos/new', {alumno: alumno, errors: err.errors});
				...
				alumno.save({fields: ["dni","nombre", "apellido1", "apellido2", "email", "grupoAlumno"]}).then(function(){
					res.redirect('/admin/alumnos');
...
exports.update = function(req, res) {
    ...
    req.alumno.grupoAlumno = req.body.alumno.grupoAlumno;
    ...
    req.alumno
            ...
            function(err){
                if(err){
                    ...
                    req.alumno
                            .save({fields:["dni","nombre","apellido1","apellido2","email", "grupoAlumno"]})
